...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Billing Machine")  #1
        bg_color = "#ffcc00"                #2
        title = Label(self.root, text="Billing Machine", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#ffcc00", fg="#800000", relief=RIDGE)  #3
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#ffcc00")
        ...
        bil_btn = Button(F1, text="Search", command=self.find_bill, width=10, bd=7, font=('arial', 12, 'bold'), relief=RIDGE)
    ...
    # ===========ColdDrinks================================
        ...
        limka_lbl = Label(F4, text="Limka", font=('times new roman', 16, 'bold'), bg=bg_color, fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg=bg_color, fg="black")
